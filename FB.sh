...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# Jangan Recode Ya guys
# Nggak baik inget :v
# Recode gk bakalan jadi lu mastah
echo
echo
echo
...
echo $ku"Facebook :"$i" Xienan Chefao"
sleep 2
echo $pur">> Thanks Kawan yang Sudah Support Saya <<"
exit
fi
